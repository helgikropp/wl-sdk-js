...
/**
 * @typedef Wl_Book_Cancel_CancelCanModel_GetResponse
 * @type {object}
 * @property {?Wl_Book_Cancel_CancelCanModel_a_penalty} a_penalty Penalty data.
 * <dl>
 *     <dt>bool `is_flat`</dt>
 *     <dd>`true` in a case of flat penalty type; `false` in a case of percentage penalty type.</dd>
 *     <dt>string `k_currency`</dt>
 ...
 * @returns {Promise<Wl_Book_Cancel_CancelCanModel_GetResponse>} Response from this request
 */