...
function Wl_Book_Process_Info_Info54Model()
{
  ...
  /**
   * @typedef {{}} Wl_Book_Process_Info_Info54Model_a_purchase
   ...
   *
   * @post result
   * @type {Wl_Book_Process_Info_Info54Model_a_purchase[]}
   */
